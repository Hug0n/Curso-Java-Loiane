...
public class JogoDaVelha {
	...
	void executarJogoDaVelha() {
		...
		while (game == 1) {
			...
			if (validacao()) {
				// validação se o valor da posição é NULL
				...
				if (posicao == 0) {
					...
					if (noWinner == 9) {
						game = 2;
						System.out.println("Não houve vencedor dessa vez! Tentem novamente ;D");
		...
		if (game != 2) {
			System.out.println("Não se preocupe, " + jogador + "! Nos vemos na revanche!");
		}
	}
		...
		for (int i = 0; i < JogoDaVelha.length; i++) {
			...
			for (int j = 0; j < JogoDaVelha.length; j++) {
				if (JogoDaVelha[i][j] == valorJogador) {
					verify++;
					if (verify == 3) {
						System.out.println("O jogador " + jogador + " preencheu 1 linha e ganhou! Parabéns! ");
						game = 0;
						break;
					}
				}
		...
		for (int i = 0; i < JogoDaVelha.length; i++) {
			for (int j = 0; j < JogoDaVelha[i].length; j++) {
				if (JogoDaVelha[j][marcaColuna] == valorJogador) {
					verify++;
					if (verify == 3) {
						System.out.println("O jogador " + jogador + " preencheu 1 coluna e ganhou! Parabéns! ");
						game = 0;
						break;
					}
				}
	...
	void verificarDiagonaisDE() {
		...
		for (int i = 0; i < JogoDaVelha.length; i++) {
			if (JogoDaVelha[marcaLinha][marcaColuna] == valorJogador) {
				verify++;
				if (verify == 3) {
					System.out.println("O jogador " + jogador + " preencheu 1 diagonal D-E e ganhou! Parabéns! ");
					game = 0;
					break;
				}
			}
	...
	void verificarDiagonaisED() {
		...
		for (int i = 0; i < JogoDaVelha.length; i++) {
			if (JogoDaVelha[marcaLinha][marcaColuna] == valorJogador) {
				verify++;
				if (verify == 3) {
					System.out.println("O jogador " + jogador + " preencheu 1 diagonal E-D e ganhou! Parabéns! ");
					game = 0;
					break;
				}
			}
